...
function generateMonthlyRevenue(currentMrr: number) {
...
export const mockVisitors: Visitor[] = [
  ...
  { id: 'v11', name: 'lucas miller',   avatarSeed: 'lucas',    countryFlag: flag('us'), countryName: 'United States', city: 'San Francisco, US', os: 'Mac OS', device: 'Desktop', browser: 'Chrome', referrer: 'Google', currentUrl: '/game', sessionTime: '9 min 14 sec', totalVisits: 3, conversionLikelihood: 81, estimatedValue: 0.32, top: 30, left: 14, dotColor: '#3b82f6' },
...
export const whatsHappeningPosts: WhatsHappeningPost[] = [
  ...
  { id: 'p7',  founderHandle: 'caitlin',  startupName: 'PicX Studio',    startupSlug: 'mock-3',        timestamp: '8h',  text: "I'm running three agents in parallel, shipping new features very fast.", hasImage: true, imageGradient: 'linear-gradient(135deg,#0a0a0a,#1a1a1a)', imageCaption: 'terminal output', likes: 1, comments: 0 },
