import { bl as Va, bm as il } from "./index-B-37iCee.js";
import { _ as La } from "./valuationExportPdf-Df2SDODr.js";
import "./valuation-B56Orlp6.js";
var fn = {},
  cn = {},
  cr,
  vn;
...
function Vr() {
  ...
  return ((Ft = { EXISTS: i, PROPER: a, CONFIGURABLE: s }), Ft);
}
var Ut, is;
function Wa() {
  if (is) return Ut;
...
function Lr() {
  ...
  return ((Ht = { set: c, get: v, has: f, enforce: g, getterFor: d }), Ht);
}
var us;
function cl() {
...
function vl() {
  ...
  return ((ei = { includes: t(!0), indexOf: t(!1) }), ei);
}
var ri, ps;
function gl() {
  if (ps) return ri;
        ...
        : d && d.now
          ...
          : y && !h
            ...
            : n.addEventListener &&
                ...
                E.protocol !== "file:" &&
                !a(k)
              ? ((T = k), n.addEventListener("message", I, !1))
              : S in u("script")
                ? (T = function (w) {
...
function br() {
  ...
  return ((Bi = { CONSTRUCTOR: f, REJECTION_EVENT: v, SUBCLASSING: c }), Bi);
}
var Fi = {},
  io;
function xr() {
...
function Oh() {
  ...
  var n = fe(),
    ...
    q = T.f,
    U = q,
    L = !!(j && j.createEvent && t.dispatchEvent),
    $ = "unhandledrejection",
    X = "rejectionhandled",
    ae = 0,
    oe = 1,
    ...
    xe = function (C, F) {
      ...
      try {
        W
          ? (H || (F.rejection === Ge && $e(F), (F.rejection = Ue)),
            W === !0
              ? (Ee = z)
              : (Se && Se.enter(), (Ee = W(z)), Se && (Se.exit(), (hr = !0))),
            Ee === C.promise
              ? Le(new N("Promise-chain cycle"))
              : (lr = ve(Ee))
                ? a(lr, Ee, Te, Le)
                : Te(Ee))
          : Le(z);
    ...
    De = function (C, F) {
      C.notified ||
        ((C.notified = !0),
        p(function () {
          for (var z = C.reactions, H; (H = z.get()); ) xe(H, C);
    ...
    Ve = function (C, F, z) {
      var H, W;
      (L
        ? ((H = j.createEvent("Event")),
          (H.promise = F),
          (H.reason = z),
          H.initEvent(C, !1, !0),
          t.dispatchEvent(H))
        : (H = { promise: F, reason: z }),
        !A && (W = t["on" + C])
          ? W(H)
          : C === $ && y("Unhandled promise rejection", z));
    },
    Xe = function (C) {
      a(d, t, function () {
        var F = C.facade,
    ...
    de = function (C, F, z) {
      C.done ||
        ((C.done = !0), z && (C = z), (C.value = F), (C.state = ue), De(C, !0));
    },
    Oe = function (C, F, z) {
      if (!C.done) {
        ((C.done = !0), z && (C = z));
  ...
  return (
    n({ global: !0, constructor: !0, wrap: !0, forced: P }, { Promise: V }),
    (_e = i.Promise),
    u(V, R, !1, !0),
    l(R),
    cn
        ...
        return (
          B
            ? L
              ...
              : (R.lastIndex = 0)
            : y && L && (R.lastIndex = R.global ? L.index + L[0].length : w),
          b &&
            L &&
            L.length > 1 &&
            n(h, L[0], k, function () {
      ...
      return [
        ...
        function (p) {
          ...
          for (var E = [], T = 0, R; (R = c(y, m)) !== null; ) {
            var P = s(R[0]);
            ((E[T] = P),
              P === "" && (y.lastIndex = l(m, a(y.lastIndex), S)),
              T++);
          }
          return T === 0 ? null : E;
        },
    ...
    n(
      { target: "String", proto: !0, forced: !v && !c },
      {
        startsWith: function (g) {
          ...
          a(g);
          var p = i(g),
            y = t(h(arguments.length > 1 ? arguments[1] : void 0, d.length));
...
function Il() {
  ...
  return (
    ...
    (ba = { IteratorPrototype: h, BUGGY_SAFARI_ITERATORS: l }),
    ba
  );
}
var xa, au;
  ...
  return (
    (Oa = function (T, R, P, A, D, I, k) {
      ...
      var w = function (X) {
        ...
        B = !1,
        N = T.prototype,
        j = N[m] || N["@@iterator"] || (D && N[D]),
        _ = (!y && j) || w(D),
        q = (R === "Array" && N.entries) || j,
        U,
        L,
        $;
      if (
        ...
        if (((L = { values: w(x), keys: I ? _ : w(b), entries: w(S) }), k))
          for ($ in L) (y || B || !($ in N)) && h(N, $, L[$]);
        else n({ target: R, proto: !0, forced: y || B }, L);
      return (
        (!r || k) && N[m] !== _ && h(N, m, _, { name: D }),
        (v[R] = _),
        L
      );
    }),
...
function rf() {
  ...
  return ((Ca = { left: s(!1), right: s(!0) }), Ca);
}
var wa, gu;
function _l() {
  if (gu) return wa;
        ...
        return [
          ...
          function (D, I) {
            ...
            for (var U = 0, L = 0, $ = []; L < w.length; ) {
              ...
              if (
                X === null ||
                (ae = y(u(_.lastIndex + (d ? L : 0)), w.length)) === U
              )
                L = o(w, L, j);
              else {
...
function qa(n, e, r) {
  ...
  var o = ja([(e - a) / 2, (r - s) / 2], (-n.xRot / 180) * ze),
    u = o[0],
    l = o[1],
        ...
        if (f.xRot !== void 0 && (o !== 1 || u !== 0 || l !== 0 || h !== 1))
          if (T === 0)
            ...
            var R = (f.xRot * Math.PI) / 180,
              ...
              V = E(P) * D + E(A) * I,
              B = k * h * h - w * u * h + V * u * u,
              N = w * (o * h + u * l) - 2 * (k * l * h + V * o * u),
              j = k * l * l - w * o * l + V * o * o,
              _ = ((Math.atan2(N, B - j) + Math.PI) % Math.PI) / 2,
              q = Math.sin(_),
              U = Math.cos(_);
            ((f.rX = Math.abs(T) / Math.sqrt(B * E(U) + N * q * U + j * E(q))),
              (f.rY = Math.abs(T) / Math.sqrt(B * E(q) - N * q * U + j * E(U))),
              (f.xRot = (180 * _) / Math.PI));
          }
        return (
          f.sweepFlag !== void 0 && 0 > T && (f.sweepFlag = +!f.sweepFlag),
          f
        );
      })
    );
  ...
  ((n.ROUND = function (o) {
    ...
    (n.SANITIZE = function (o) {
      ...
      return i(function (v, f, g, d, p) {
            ...
            (x = isNaN(c)
              ? v.y1 === void 0
                ...
                : v.relative
                  ...
                  : v.y1 - g
              : c - g));
          var T = v.x2 === void 0 ? 0 : v.relative ? v.x : v.x2 - f,
            R = v.y2 === void 0 ? 0 : v.relative ? v.y : v.y2 - g;
          y(S) <= o &&
            y(E) <= o &&
            y(b) <= o &&
            y(x) <= o &&
        ...
        return (
          v.type & O.CLOSE_PATH && y(f - d) <= o && y(g - p) <= o && (m = !0),
          m ? [] : v
        );
      });
    }),
        ...
        return O.ARC === o.type
          ? (function (h, c, v) {
              ...
              for (
                ...
                var R = Vu(h.phi1, h.phi2, T / b),
                  P = Vu(h.phi1, h.phi2, (T + 1) / b),
                  A = P - R,
                  D = (4 / 3) * Math.tan((A * ke) / 4),
                  I = [
                    Math.cos(R * ke) - D * Math.sin(R * ke),
                    Math.sin(R * ke) + D * Math.cos(R * ke),
                  ],
                  k = I[0],
                  w = I[1],
                  V = [Math.cos(P * ke), Math.sin(P * ke)],
                  B = V[0],
                  N = V[1],
                  j = [B + D * Math.sin(P * ke), N - D * Math.cos(P * ke)],
                  _ = j[0],
                  q = j[1];
                x[T] = { relative: h.relative, type: O.CURVE_TO };
                var U = function (L, $) {
                  var X = ja([L * h.rX, $ * h.rY], h.xRot),
                    ae = X[0],
                    oe = X[1];
    ...
    (n.CALCULATE_BOUNDS = function () {
      var o = function (v) {
        ...
        c = i(function (v, f, g) {
          ...
          if (
            (d.type & O.DRAWING_COMMANDS && (p(f), y(g)),
            d.type & O.HORIZ_LINE_TO && p(d.x),
            d.type & O.VERT_LINE_TO && y(d.y),
            d.type & O.LINE_TO && (p(d.x), y(d.y)),
            d.type & O.CURVE_TO)
          ) {
            (p(d.x), y(d.y));
...
`
  ...
  Tf =
    (((Re = {})[O.MOVE_TO] = 2),
    (Re[O.LINE_TO] = 2),
    (Re[O.HORIZ_LINE_TO] = 1),
    (Re[O.VERT_LINE_TO] = 1),
    (Re[O.CLOSE_PATH] = 0),
    (Re[O.QUAD_TO] = 4),
    (Re[O.SMOOTH_QUAD_TO] = 2),
    (Re[O.CURVE_TO] = 6),
    (Re[O.SMOOTH_CURVE_TO] = 4),
    (Re[O.ARC] = 7),
    Re),
  Fu = {},
  Uu;
...
function Af(n, e, r, t, i, a) {
  ...
  for (
    ...
    f = v;
    for (
      var T = s[b], R = s[b + 1], P = s[b + 2], A = s[b + 3], D = 0;
      D < h;
      D++
    )
...
var zc = Object.freeze({ __proto__: null, offscreen: If, node: Nf });
function or(n) {
...
class $r {
  ...
  setViewBox(e) {
    ...
    (x === "meet" && ((P *= T), (A *= T)),
      x === "slice" && ((P *= R), (A *= R)));
    var D = new M(r, "refX", c),
      I = new M(r, "refY", v),
      k = D.hasValue() && I.hasValue();
    ...
    if (!k) {
      var B = x === "meet" && T === E,
        ...
        j = x === "meet" && T === S,
        _ = x === "slice" && R === S;
      (b.startsWith("xMid") && (B || N) && t.translate(a / 2 - P / 2, 0),
        b.endsWith("YMid") && (j || _) && t.translate(0, o / 2 - A / 2),
        b.startsWith("xMax") && (B || N) && t.translate(a - P, 0),
        b.endsWith("YMax") && (j || _) && t.translate(0, o - A));
    }
    switch (!0) {
      case b === "none":
        t.scale(S, E);
  ...
  render(e, r, t, i, a, s, o) {
    ...
    if (
      ...
      var m = me(e.getAttribute("viewBox").getString()),
        b = 0,
        x = 0;
      if (typeof i == "number") {
...
class ir extends K {
  ...
  setContext(e) {
    ...
    if (!r) {
      ...
      if (i.hasValue()) {
        var l = new M(this.document, "fill", e.fillStyle)
          .addOpacity(i)
          .getColor();
        e.fillStyle = l;
      }
      ...
      if (s.hasValue()) {
        var v = new M(this.document, "stroke", e.strokeStyle)
          .addOpacity(s)
          .getString();
        e.strokeStyle = v;
      }
    ...
    if (((this.modifiedEmSizeStack = !1), typeof e.font < "u")) {
      var E = this.getStyle("font"),
        ...
        R = this.getStyle("font-variant"),
        P = this.getStyle("font-weight"),
        A = this.getStyle("font-size"),
        D = this.getStyle("font-family"),
        I = new le(
          T.getString(),
          R.getString(),
          P.getString(),
          ...
          D.getString(),
          le.parse(E.getString(), e.font),
        );
      (T.setValue(I.fontStyle),
        R.setValue(I.fontVariant),
        P.setValue(I.fontWeight),
        A.setValue(I.fontSize),
        D.setValue(I.fontFamily),
        (e.font = I.toString()),
        A.isPixels() &&
...
class Y extends ir {
  constructor(e, r, t) {
    (super(e, r, t),
      ...
      (this.pathParser = new G(this.getAttribute("d").getString())));
  }
  path(e) {
...
class We extends ir {
  ...
  getFontSize() {
    var { document: e, parent: r } = this,
      t = le.parse(e.ctx.font).fontSize,
...
class cc extends K {
  ...
  createPattern(e, r, t) {
    ...
    for (var c = -1; c <= 1; c++)
      for (var v = -1; v <= 1; v++)
        (u.save(),
          (s.attributes.x = new M(this.document, "x", c * o.width)),
          (s.attributes.y = new M(this.document, "y", v * o.height)),
          s.render(u),
          u.restore());
  ...
  createGradient(e, r, t) {
    ...
    if (
      ...
      var { document: o } = this,
        ...
        [h] = l.viewPorts,
        c = new Gl(o, null);
      ((c.attributes.x = new M(o, "x", -u / 3)),
        (c.attributes.y = new M(o, "y", -u / 3)),
        (c.attributes.width = new M(o, "width", u)),
        (c.attributes.height = new M(o, "height", u)));
      var v = new ln(o, null);
      ((v.attributes.transform = new M(
        ...
        (v.children = [c]));
      var f = new Tr(o, null);
      ((f.attributes.x = new M(o, "x", 0)),
        (f.attributes.y = new M(o, "y", 0)),
        (f.attributes.width = new M(o, "width", h.width)),
        (f.attributes.height = new M(o, "height", h.height)),
        (f.children = [v]));
...
class hn extends K {
  constructor(e, r, t) {
    (super(e, r, t),
      ...
      (this.values = new M(e, "values", null)));
  ...
  getProgress() {
    ...
    if (r.hasValue()) {
      var i = t.progress * (r.getValue().length - 1),
        a = Math.floor(i),
        s = Math.ceil(i);
      ((t.from = new M(e, "from", parseFloat(r.getValue()[a]))),
        (t.to = new M(e, "to", parseFloat(r.getValue()[s]))),
        (t.progress = (i - a) / (s - a)));
  ...
  renderChildren(e) {
    if (this.hasText) {
      ...
      var { document: r, x: t, y: i } = this,
        { mouse: a } = r.screen,
        s = new M(r, "fontSize", le.parse(r.ctx.font).fontSize);
      a.isWorking() &&
        a.checkBoundingBox(
          this,
  ...
  parsePathData(e) {
    ...
    for (t.reset(); !t.isEnd(); ) {
      ...
      o.type !== G.CLOSE_PATH
        ...
        : r.push({ type: G.CLOSE_PATH, points: [], pathLength: 0 });
    }
    return r;
  }
  pathM(e, r) {
    ...
    if (t) {
      ...
      if (
        (t.type === "symbol" &&
          ...
          (i.attributes.overflow = new M(
            r,
            "overflow",
            t.getAttribute("overflow").getString(),
          )),
          (i.children = t.children),
          (t.styles.opacity = new M(r, "opacity", this.calculateOpacity()))),
        i.type === "svg")
      ) {
        var a = this.getStyle("width", !1, !0),
          s = this.getStyle("height", !1, !0);
        (a.hasValue() &&
          (i.attributes.width = new M(r, "width", a.getString())),
          s.hasValue() &&
            (i.attributes.height = new M(r, "height", s.getString())));
      }
      var o = i.parent;
    ...
    if (a) {
      ...
      if (!(h < 1 || c < 1)) {
        var v = Math.floor(a.x),
          f = Math.floor(a.y),
          g = this.removeStyles(r, Wr.ignoreStyles),
...
class gr {
  constructor(e, r) {
    ...
    ((this.parser = new Da(t)),
      (this.screen = new $r(e, t)),
      (this.options = t));
    var i = new He(this, t),
