...
export type RouteLayer = 'platform' | 'marketplace' | 'product' | 'auth' | 'account';
...
export type RouteApp = 'public' | 'shared' | 'ownerr' | 'marketplace' | 'ownerr-network';
...
export const PRODUCT_ROUTES = {
  ...
  ownerrNetworkShare: (username: string) => `/share/network/${encodeURIComponent(username)}`,
} as const;
...
export const MARKETPLACE_ROUTES = {
  ...
  founder: (handle: string) => `/marketplace/founder/${encodeURIComponent(handle)}`,
  app: '/marketplace/app',
...
type DefInput = Pick<
  RouteDefinition,
  'id' | 'pathname' | 'layer' | 'postLoginDefault' | 'fallbackRoute' | 'layoutShell'
> &
  Partial<Omit<RouteDefinition, 'id' | 'pathname' | 'layer' | 'postLoginDefault' | 'fallbackRoute' | 'layoutShell'>>;
...
function def(partial: DefInput): RouteDefinition {
  ...
  return {
    ...
    publicWebsiteRoute,
    appInternalRoute,
    allowWhenAuthenticated: partial.allowWhenAuthenticated ?? publicWebsiteRoute,
...
export const ROUTE_REGISTRY: readonly RouteDefinition[] = [
  ...
  def({
    id: 'ownerr-os.app.referrals',
    pathname: PRODUCT_ROUTES.ownerrOsReferrals,
    layer: 'product',
    product: 'ownerr-os',
    authRequired: true,
    authProduct: 'ownerr-os',
    requiredRoles: ['founder'],
    layoutShell: 'authenticated-app',
    postLoginDefault: PRODUCT_ROUTES.ownerrOsReferrals,
    fallbackRoute: PRODUCT_ROUTES.ownerrOsLanding,
  }),
  def({
  ...
  def({
    id: 'platform.pricing',
    pathname: PUBLIC_ROUTES.pricing,
    layer: 'platform',
    product: null,
    authRequired: false,
    layoutShell: 'marketing',
    postLoginDefault: PUBLIC_ROUTES.pricing,
    fallbackRoute: PUBLIC_ROUTES.home,
  }),
  def({
...
export const DEFAULT_ROUTE = ROUTE_REGISTRY.find((r) => r.id === 'platform.home')!;
