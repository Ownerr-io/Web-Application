  ...
  const handleGuess = (index: 0 | 1) => {
    ...
    if (correct) {
      ...
      if (newScore > highScore) {
        ...
        localStorage.setItem("ownerr_highscore", newScore.toString());
      }
    } else {
      setScore(0);
    }
    ...
    <div className="max-w-4xl mx-auto flex flex-col items-center text-center gap-8 py-8">
        ...
        {pair.map((startup, index) => (
          <motion.div
            ...
            className={`startup-card p-8 flex flex-col items-center cursor-pointer transition-all duration-300 ${
              revealed
                ? startup.revenue === Math.max(pair[0].revenue, pair[1].revenue)
                  ? "border-green-500 shadow-lg bg-[#E6FFE8]"
                  : "opacity-50"
          ...
          >
            <div
              ...
              style={{
                backgroundColor: startup.logoColor,
              ...
              <AnimatePresence mode="wait">
                {revealed ? (
                  ...
                  >
                    ...
                    <span className="text-sm text-muted-foreground block font-normal mt-1 uppercase tracking-wider">
                      MRR
                    </span>
                  </motion.div>
                ) : (
      ...
      <AnimatePresence>
        {revealed && (
          ...
          >
            <div
              className={`text-2xl font-bold ${isCorrect ? "text-green-600" : "text-red-500"}`}
            >
