...
const CHANNELS = [
  ...
  },
  {
    ...
    title: "Product & demos",
    description:
      "Questions about OWNERR OS, Unemployed Network, or getting started.",
        ...
        <section className="landing-saas-hero relative overflow-hidden border-b border-[color:var(--terminal-border)]/80">
          ...
          <div className="saas-section-shell relative z-10 py-12 md:py-16 lg:py-20">
            ...
            >
              ...
              >
                Enterprise onboarding, partnerships, and product questions. We
          ...
          <div className="flex flex-col gap-6 lg:flex-row lg:items-start lg:justify-between">
            <div>
              ...
              <p className="marketing-body-sm mt-2 max-w-md">
                Many questions are answered in the product — valuation,
                marketplace, and product apps are available now.
              </p>
            </div>
              ...
              {QUICK_LINKS.map((item) => (
                <li key={item.href}>
                  ...
                  >
                    {item.label}
                    <ArrowRight
                      className="h-4 w-4 text-[color:var(--terminal-muted)]"
                      aria-hidden
                    />
                  </Link>
                </li>
            ...
            <div className="flex min-w-0 flex-1 items-start gap-3">
              ...
              <div>
                <p className="text-sm font-bold text-[color:var(--terminal-fg)]">
                  Ready to join OWNERR?
                </p>
                <p className="mt-1 text-sm text-[color:var(--terminal-muted)]">
                  Create one account for valuation, marketplace, and product
                  apps.
                </p>
              </div>
            </div>
