...
import { ensureBuyerProfile, getBuyerProfileId } from '@/lib/marketplace/profiles';
...
function profileFrom(row: BidRow): { auth_user_id: string; metadata: Record<string, unknown> } | null {
...
export async function listBidsForStartupSlug(slug: string): Promise<MarketplaceBid[]> {
...
export async function listBidsForBuyer(authUserId: string): Promise<MarketplaceBid[]> {
...
export function minNextBidAmount(basePrice: number, highest: number | null): number {
