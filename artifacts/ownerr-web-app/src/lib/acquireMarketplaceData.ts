...
And I sold it thanks to ownerr.io of @marclou in just a few days.
...
I'm preparing a thread that will explain why it works better on ownerr`,
  ...
  },
  {
    ...
    handle: 'kilozua5kdm',
    avatarSeed: 'mohamedm',
    body: 'Huge thanks to\n@marclou\n! Thanks to ownerr.io, I just made my first SaaS sale directly through WhatsApp and paypal with ownerr.io. It’s amazing what a little help can do… and this is just the beginning! #SaaS #Entrepreneur  Next SaaS is coming… $1 MILLION estimated resale value !',
  ...
  },
  {
    ...
    handle: 'ky__zo',
    avatarSeed: 'kyzo',
    body: "wow i listed my startup in @marclou 's ownerr.io and got first acquisition offer in 15 minutes.\n\nsick",
  ...
  },
  {
    ...
    avatarSeed: 'effie',
    body: "Just sold my first ever startup on ownerr.io!\n\nNever thought this was possible, always wanted a platform where you could directly just get buyers for projects even with low revenue. ownerr.io was the thing I was looking for, and it turned out to be super useful.\n\nThanks @marclou",
