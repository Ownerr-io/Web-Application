...
export const FEED_TOP_STARTUPS: {
  ...
  {
    name: "HanziStroke Pro — Lifetime Access",
    mrr: "$335/mo",
    growthPct: 6609,
    slug: "mock-0",
  },
  {
    name: "Ad Library Accelerator - Chrome Plugin for Facebook Ad Library / Meta / Instagram in Europe",
    mrr: "$3.6k/mo",
    growthPct: 5823,
    slug: "b2c-b2b-proxy",
    letter: "A",
...
export const FEED_POSTING_STREAKS: {
  name: string;
  streak: number;
  seed: string;
