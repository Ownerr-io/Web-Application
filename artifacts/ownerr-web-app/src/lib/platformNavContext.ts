...
export function getPlatformProductContext(location: string): PlatformProductContext {
...
export const productContextLabels: Record<Exclude<PlatformProductContext, null>, string> = {
