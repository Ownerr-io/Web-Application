...
export function buildAnalysisSignals(
  ...
  const signals: AnalysisSignal[] = [
    {
      ...
      value: arr > 0 ? `${formatShortCurrency(arr)} ARR` : "Deriving from MRR",
    },
    {
      id: "growth",
      label: "Growth velocity",
      value: `${inputs.monthlyGrowthPct.toFixed(1)}% MoM`,
    },
    {
      id: "unit",
      ...
      value:
        inputs.cac > 0 && inputs.ltv > 0
          ? `LTV/CAC ${(inputs.ltv / inputs.cac).toFixed(1)}×`
          : "Unit economics pending",
    },
    {
      id: "churn",
      label: "Retention curve",
      value: `${inputs.churnPctMonthly.toFixed(1)}% monthly churn`,
    },
    {
      id: "burn",
    ...
    },
    {
      ...
      value: `${Math.round(inputs.runwayMonths)} months`,
    },
    {
      id: "market",
      label: "Market context",
      value: `${inputs.industry} · ${inputs.geography}`,
    },
