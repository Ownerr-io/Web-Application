      ...
      {insights.map((card, idx) => (
        ...
        >
          <div className="mb-2 flex items-start justify-between gap-2">
            <h3 className="text-sm font-bold leading-snug text-[color:var(--terminal-fg)]">{card.title}</h3>
          ...
          <p className="mb-3 flex-1 text-xs leading-relaxed text-[color:var(--terminal-muted)]">{card.explanation}</p>
          <div className="mb-2 text-[10px] font-bold uppercase tracking-wider text-[color:var(--terminal-muted)]">Referenced</div>
          ...
          <p className="border-t border-[color:var(--terminal-border)] pt-3 text-[11px] leading-snug text-[color:var(--terminal-muted)]">
            <span className="font-bold text-[color:var(--terminal-ochre)]">Market reasoning · </span>
            {card.reasoning}
          </p>
        </motion.article>
      ))}
