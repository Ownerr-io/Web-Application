    ...
    <section className="platform-section-panel relative overflow-hidden rounded-[12px] p-6 sm:p-8">
      ...
      <div className="relative space-y-3">
        ...
        <h2 className="text-balance text-2xl sm:text-3xl">
          Everything on <span className="platform-gradient-text">OWNERR</span>, explained
        </h2>
        <p className="max-w-2xl text-sm leading-relaxed text-[color:var(--terminal-muted)]">
          You do not need five disconnected tools. Valuation, intelligence, marketplace execution, founder growth, and
          workforce network share the same dark terminal — and the same lime · orange · red brand system from our mark.
        </p>
      </div>
          ...
          <li key={item.id}>
            ...
            >
              <div className="flex items-start justify-between gap-2">
                <h3 className="text-base font-bold text-[color:var(--terminal-display)]">{item.label}</h3>
              ...
              <span className="mt-4 text-[10px] font-bold uppercase tracking-widest text-brand-orange">Open product</span>
            </Link>
          </li>
        ))}
      </ul>
