...
const METRICS = [
  {
    value: "68%",
    label: "Verified listing share",
    sub: "Quality-weighted marketplace supply",
  },
  { value: "11.4d", label: "Median time-to-IOI", sub: "Counterparty velocity" },
  {
    value: "5",
    label: "Integrated products",
    sub: "Single platform architecture",
  },
  {
    value: "24/7",
    label: "Desk-native terminal",
    sub: "Scenarios refresh on edit",
  },
] as const;
  ...
  return (
    <section className="luxury-section-gap saas-section-shell border-t border-[color:var(--terminal-border)]/60">
      <SectionHeader
        ...
        title={
          <>
            Traction that reads like a{" "}
            <span className="platform-gradient-text">private desk</span>
          </>
        }
        ...
        {METRICS.map((m) => (
          <RevealItem key={m.label}>
            <div className="luxury-panel h-full px-6 py-8 sm:px-7">
              ...
              <p className="mt-4 text-sm font-bold text-[color:var(--terminal-fg)]">
                {m.label}
              </p>
