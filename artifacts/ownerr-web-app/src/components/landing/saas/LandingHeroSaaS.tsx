      ...
      <div className="saas-section-shell relative z-10 grid min-h-[min(92svh,880px)] items-center gap-12 py-14 md:grid-cols-12 md:gap-10 md:py-20 lg:py-24">
        ...
        >
          ...
          <motion.h1
            variants={fadeUp}
            custom={1}
            className="marketing-hero-title max-w-[16ch]"
          >
            <span className="text-[color:var(--terminal-display)]">
              Valuation intelligence
            </span>
            <span className="mt-2 block platform-gradient-text">
          ...
          <motion.p
            variants={fadeUp}
            custom={2}
            className="marketing-lead max-w-md"
          >
            Model the business, read the market, and execute on verified supply
            — one bespoke terminal. No generic startup chrome; built for desks
            that close.
          </motion.p>
          ...
          <motion.p
            variants={fadeUp}
            custom={4}
            className="mt-12 text-xs font-semibold tracking-wide text-[color:var(--terminal-muted)]"
          >
            <span className="text-[color:var(--terminal-fg)]">
              Institutional models
            </span>
            <span className="mx-2.5 font-normal text-[color:var(--terminal-border)]">
              /
            </span>
            Verified listings
            <span className="mx-2.5 font-normal text-[color:var(--terminal-border)]">
          ...
          <div className="luxury-panel overflow-hidden rounded-[10px]">
            ...
            <div className="border-t border-[color:var(--terminal-border)]/80 px-5 py-4">
              <p className="text-xs leading-relaxed text-[color:var(--terminal-muted)]">
                Scenario outputs refresh as inputs change — the same engine
                powering the full valuation workspace.
              </p>
              <Link
                href={marketingRoutes.valuation}
