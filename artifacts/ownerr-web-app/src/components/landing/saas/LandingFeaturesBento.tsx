...
const CAPABILITIES = [
  {
    ...
    body: "Live valuation as you edit.",
    href: marketingRoutes.valuation,
    wide: true,
  },
  {
    title: "Market intelligence",
    body: "Multiples and flow in one view.",
    href: marketingRoutes.marketIntelligence,
    wide: false,
  },
  {
    title: "Verified listings",
    body: "Supply aligned to your model.",
    href: marketplacePath("/"),
    wide: false,
  },
  {
    title: "Structured deals",
    body: "Acquisition with clear audit trails.",
    href: marketingRoutes.howItWorks,
    wide: false,
  },
  {
    title: "Founder OS",
    body: "Share cards and referral loops.",
    href: marketingRoutes.ownerrOs,
    wide: false,
  },
  {
    title: "Ownerr Network",
    body: "Profile, discovery, reputation, and referrals.",
    href: marketingRoutes.ownerrNetwork,
    wide: false,
  },
] as const;
    ...
    <section className="luxury-section-gap saas-section-shell border-t border-[color:var(--terminal-border)]/60">
      ...
      <RevealStagger className="mt-14 grid grid-cols-1 gap-3 sm:grid-cols-2 lg:grid-cols-3">
        {CAPABILITIES.map((c) => (
          <RevealItem
            key={c.title}
            className={cn(c.wide && "sm:col-span-2 lg:col-span-2")}
          >
            <Link
              href={c.href}
              className={cn(
