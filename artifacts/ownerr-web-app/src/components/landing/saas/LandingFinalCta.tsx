        ...
        <div className="platform-gradient-border rounded-[10px] p-px">
          <div className="luxury-panel relative overflow-hidden rounded-[9px] px-6 py-12 md:grid md:grid-cols-12 md:items-center md:gap-10 md:px-10 md:py-14 lg:px-14">
            ...
            <div className="relative md:col-span-7">
              ...
              <span className="luxury-rule mt-4 block max-w-[200px]" aria-hidden />
              ...
              <p className="mt-4 max-w-md text-sm leading-relaxed text-[color:var(--terminal-muted)] sm:text-[15px]">
                Valuation workspace is free in beta. When you are ready, marketplace and intelligence sit on the same
                login — one customised Ownerr experience.
              </p>
            </div>
            <div className="relative mt-10 flex flex-col gap-3 md:col-span-5 md:mt-0">
              ...
              <p className="pt-2 text-center text-xs text-[color:var(--terminal-muted)] md:text-left">
                <Link href={marketplacePath('/acquire')} className="font-semibold text-brand-lime hover:underline">
                  Acquisitions
                </Link>
                <span className="mx-2 text-[color:var(--terminal-border)]">/</span>
                <Link href={marketingRoutes.ownerrOs} className="font-semibold text-brand-orange hover:underline">
                  Founder OS
                </Link>
              </p>
            </div>
