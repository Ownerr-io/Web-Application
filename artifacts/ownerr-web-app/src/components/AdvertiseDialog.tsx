      ...
      <DialogContent className="max-h-[min(90dvh,880px)] max-w-xl overflow-y-auto border-border bg-card p-6 text-card-foreground shadow-2xl sm:max-w-lg">
        ...
        <div className="space-y-2">
          ...
          <p className="text-sm leading-relaxed text-muted-foreground">
            ...
            and mobile banners across all Ownerr pages. Sponsors rotate every 10
            seconds to ensure fair visibility among all advertisers.
          </p>
        </div>
        ...
        <div className="rounded-[12px] border border-border bg-muted/40 p-4">
          ...
          <p className="mt-2 text-sm font-semibold text-foreground">
            Monthly rate: $1,499/month
          </p>
          <p className="mt-1 text-sm text-muted-foreground">
            <span className="font-bold text-foreground">1 spot</span> available
            now. Cancel anytime.
          </p>
        </div>

        <Button asChild className="h-11 w-full rounded-[10px] font-bold">
          <a
            ...
            {TESTIMONIALS.map((t) => (
              <li key={t.seed} className="flex gap-3 text-sm">
                ...
                <div className="min-w-0">
                  ...
                  <blockquote className="mt-1 text-muted-foreground leading-snug">
                    &ldquo;{t.quote}&rdquo;
                  </blockquote>
                </div>
              </li>
